...
!  Export:
     ...
     Integer*8, Intent(OUT) :: pDATA
     Integer*8, Intent(OUT) :: pMASK
     Integer*8, Intent(OUT) :: pXAXIS
     Integer*8, Intent(OUT) :: pYAXIS
     Integer*8, Intent(OUT) :: pVARIANCES
     Integer*8, Intent(OUT) :: pMDATA
     Integer*8, Intent(OUT) :: pMXAXIS
     Integer*8, Intent(OUT) :: pMYAXIS
     Integer*8, Intent(OUT) :: pMVARIANCES
