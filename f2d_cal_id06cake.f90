...
!  ************************
!  *                      *
!  * f2d_cal_id06cake.f90 *
!  *                      *
!  ************************
 
!+ F2D_CAL_ID06CAKE -  CALculate "CAKE" region: radial/azimuth re-binning
...
!  History:
!    27-Nov-2014: V0.4 Stop array size, increasing more than once! (Hammersley)
!    26-Nov-2014: V0.3 Increase array size for "detector_offset" values 
!      (Hammersley)
!    30-Apr-2014: V0.2 Add "azimuth_start, azimuth_end" variables (Hammersley)
!    06-Mar-2014: V0.1 Original, based on "F2D_CAL_CAKE" (Hammersley)
!  Type Definitions:
     Implicit None
     Include 'io.inc'
!  Global Constants:
...
!  Check input status
     If (status .Ne. St_goodvalue) Then
        Call ST_SAVE ('Subroutine F2D_CAL_ID06CAKE ' // Version)
        Return
     End If
...
!     Allow experimental geometry to be changed
        Call F2D_GUI_EXPERIMENT (.True., experiment, status)
...
!     options
        ...
        REALS(1) = mod_start_azimuth * 180.0 / Pi
        REALS(2) = mod_end_azimuth * 180.0 / Pi
...
!           Write (*, '(''returning from F2D_CAL_ID06CAKE: retstat = '', i6)') &
!             retstat
!**DEBUG***DEBUG***DEBUG***DEBUG***DEBUG***DEBUG***DEBUG***DEBUG***DEBUG
...
!**DEBUG***DEBUG***DEBUG***DEBUG***DEBUG***DEBUG***DEBUG***DEBUG***DEBUG***DEBUG
        ...
        Call F2D_CAL2_ID06CAKE (xmaxdat, ymaxdat, xnumdat, ynumdat, &
          xstrelm, ystrelm, xendelm, &
          yendelm, DATA, MASK, conserve_intensity, scan_type, maximum_d, &
          azimuth_start, azimuth_end, experiment, &
          mod_start_azimuth, mod_end_azimuth, inner_limit, &
...
!**DEBUG***DEBUG***DEBUG***DEBUG***DEBUG***DEBUG***DEBUG***DEBUG***DEBUG***DEBUG
!        Write (*, '(''F2D_CAL_ID06CAKE: After F2D_CAL2_CAKE'')')
!        Call GS_INPL (.False., 0, 1, .True., 'TEST INPUT', 1, &
!          'TEST INPUT', 1, 'HOW?', testl, status)
!**DEBUG***DEBUG***DEBUG***DEBUG***DEBUG***DEBUG***DEBUG***DEBUG***DEBUG***DEBUG
...
!**DEBUG***DEBUG***DEBUG***DEBUG***DEBUG***DEBUG***DEBUG***DEBUG***DEBUG***DEBUG
!     Write (*, '(''F2D_CAL_ID06CAKE: End'')')
!**DEBUG***DEBUG***DEBUG***DEBUG***DEBUG***DEBUG***DEBUG***DEBUG***DEBUG***DEBUG

     End Subroutine F2D_CAL_ID06CAKE
!********1*********2*********3*********4*********5*********6*********7*********8
