...
!  Import:
     Integer, Intent(IN) :: xmaxdat
     Integer, Intent(IN) :: ymaxdat
     Integer, Intent(IN) :: max_vec_values
     Integer, Intent(IN) :: max_vectors
...
End Subroutine
     ...
     Subroutine F2D_DIVIDE (xmaxdat, ymaxdat, xstrelm, ystrelm, xendelm, &
       yendelm, variances_exist, MDATA, MVARIANCES, DATA, VARIANCES, status)
     Implicit None
     Include 'st_symbols.inc'
!  Import:
     Integer, Intent(IN) :: xmaxdat
...
End Subroutine
     ...
     Subroutine F2D_FREEARRAYS (memory_exist, variances_exist, mask_exist, &
       ...
       pMDATA, pMXAXIS, pMYAXIS, pMVARIANCES, pVECTORS, status)
     Implicit None
     Include 'st_symbols.inc'
!  Import:
     Logical, Intent(IN) :: memory_exist
     ...
     Logical, Intent(IN) :: shared_memory
     Integer, Intent(IN) :: memory_id
     Integer, Intent(IN) :: pDATA
     Integer, Intent(IN) :: pXAXIS
     Integer, Intent(IN) :: pYAXIS
     Integer, Intent(IN) :: pVARIANCES
     Integer, Intent(IN) :: pMASK
     Integer, Intent(IN) :: pMDATA
     Integer, Intent(IN) :: pMXAXIS
     Integer, Intent(IN) :: pMYAXIS
     Integer, Intent(IN) :: pMVARIANCES
     Integer, Intent(IN) :: pVECTORS
!  Import/Export:
!  Export:
!  Status:
     Integer, Intent(INOUT) :: status
...
End Subroutine
     ...
     Subroutine F2D_GUI (fit2d_version, gui, output_graphics, shared_memory, &
       ...
       mystrelm, mxendelm, myendelm, mtitle, mxlabel, mylabel, mzlabel, &
       mx_pixel_size, my_pixel_size, max_vec_values, max_vectors, num_vectors, &
...
!  Import/Export:
     ...
     Real, Intent(INOUT) :: mx_pixel_size
     Real, Intent(INOUT) :: my_pixel_size
     Integer, Intent(INOUT) :: max_vec_values
     Integer, Intent(INOUT) :: max_vectors
     Integer, Intent(INOUT) :: num_vectors
     Integer, Intent(INOUT) :: STR_VECTORS(max_vectors)
     Integer, Intent(INOUT) :: END_VECTORS(max_vectors)
...
End Subroutine
     ...
     Subroutine F2D_GUI_MATHS (experiment, &
       ...
       xstrelm, ystrelm, xendelm, yendelm, DATA, VARIANCES, status)
     Implicit None
     Include 'io.inc'
     Include 'st_symbols.inc'
     Include 'gs_constants.inc'
...
End Subroutine
     ...
     Subroutine F2D_GUI_SCALEDSUB (experiment, xmaxdat, &
...
End Subroutine
     ...
     Subroutine F2D_GUI_VECTORS (input_options, experiment, &
       max_vec_values, max_vectors, num_vectors, &
       STR_VECTORS, END_VECTORS, VECTORS, VECTOR_TITLES, status)
     Implicit None
     Include 'io.inc'
     Include 'st_symbols.inc'
     Include 'gs_constants.inc'
...
End Subroutine
     ...
     Subroutine F2D_LSQMFIT (max_vec_values, max_vectors, y_row, x_pixel_size, &
       ...
       SCALE_FACTORS, PARAMS, PARERRORS, results_exist, RESULTS, RESERRORS, &
       RESNAMES, num_fun_calls, chisqr, MODEL, COVARIANCE, num_text, TEXT, &
       print_type, WEIGHTS, VECTORS, status)
     Implicit None
     Include 'io.inc'
     Include 'st_symbols.inc'
     Include 'f2d_lsqmfit.inc'
...
End Subroutine
     ...
     Subroutine F2D_MFITOPTIMISE (max_vec_values, max_vectors, x_pixel_size, &
       ...
       SCALE_FACTORS, PAR_BASE, PARAMS, PARERRORS, results_exist, RESULTS, &
       RESERRORS, RESNAMES, num_fun_calls, chisqr, mxnumdat, mynumdat, &
       mxstrelm, mystrelm, mxendelm, myendelm, MXAXIS, MYAXIS, MODEL, &
       COVARIANCE, num_text, TEXT, print_type, num_vectors, STR_VECTORS, &
...
!  Export:
     ...
     Character(Len = *), Intent(OUT) :: TEXT(max_text)
     Character(Len = *), Intent(OUT) :: print_type
     Integer, Intent(OUT) :: num_vectors
     Integer, Intent(OUT) :: STR_VECTORS(max_vectors)
     Integer, Intent(OUT) :: END_VECTORS(max_vectors)
     Real, Intent(OUT) :: VECTORS(max_vec_values, max_vectors)
...
End Subroutine
     ...
     Subroutine F2D_TRANSPOSE (gui, xmaxdat, ymaxdat, XAXIS, YAXIS, DATA, &
       ...
       MYAXIS, MDATA, MVARIANCES, mxnumdat, mynumdat, mxstrelm, mystrelm, &
