...
!  ************************
!  *                      *
!  * f2d_lsqcalibrant.f90 *
!  *                      *
!  ************************
 
!+ F2D_LSQCALIBRANT: Least SQuares CALIBRANT fitting (Note:
...
!  History:
!    24-Apr-2013: V0.10 Output RMS residual value (Hammersley)
!    30-Mar-2006: V0.9 Use Fortran "Allocate" for dynamic arrays (Hammersley)
!    15-Mar-2006: V0.8 Use dummy "EXPERIMENTAL_DETAILS" structure (Hammersley)
!    10-Mar-2006: V0.7 Use "EXPERIMENTAL_DETAILS" structure (Hammersley)
!    24-Feb-1997: V0.6 Rename from "F2D_LSQSILICON" (Hammersley)
!    16-Dec-1996: V0.5 Avoid open strings crossing lines (Hammersley)
!    14-Nov-1996: V0.4 Convert to "MA_MODELFIT" (Hammersley)
!    27-Aug-1996: V0.3 Correct bug which meant that fitting did not work when 
!      the wavelength was fixed (Hammersley)
!    26-Aug-1996: V0.2 Checking cos and sin "TOTAL LOSS OF PRECISION" problem 
!      (Hammersley)
!    12-Jun-1996: V0.1 Original, based on "F2D_LSQPOWDER" (Hammersley)
!  Type Definitions:
     Implicit None
     Include 'io.inc'
!  Global Constants:
...
!      parameters
!  External Functions:
     External F2D_FUNCALIBRANT
!  Local Data:
!--------1---------2---------3---------4---------5---------6---------7---------8
!  Check status
     If (status .Ne. St_goodvalue) Then
        Call ST_SAVE ('Subroutine F2D_LSQCALIBRANT ' // Version)
        Return
     End If
 
!**DEBUG***DEBUG***DEBUG***DEBUG***DEBUG***DEBUG***DEBUG***DEBUG***DEBUG
!  Write (*, '(''ENTERED F2D_LSQCALIBRANT'')')
!**DEBUG***DEBUG***DEBUG***DEBUG***DEBUG***DEBUG***DEBUG***DEBUG***DEBUG
...
!        really about zero
     ...
     End Subroutine F2D_LSQCALIBRANT
!********1*********2*********3*********4*********5*********6*********7*********8
